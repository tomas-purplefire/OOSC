  ...
  theme.Collection = (function () {
    ...
    Collection.prototype = Object.assign({}, Collection.prototype, {
      ...
      customCheckbox: function () {
        document
          .querySelectorAll(".exposed-filter-form-item")
          .forEach((filter) => {
            filter.addEventListener("click", (e) => {
              if (
                e.target.classList.contains("exposed-filter-form-item__title")
              ) {
                const link = e.target; // clicked link

                const siblings = link
                  .closest(".exposed-filter-form")
                  .querySelectorAll(".exposed-filter-form-item");
                link
                  .closest(".exposed-filter-form-item")
